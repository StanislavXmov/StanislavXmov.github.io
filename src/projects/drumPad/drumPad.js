...
import vol_0 from './sounds/01.mp3';
import vol_1 from './sounds/02.mp3';
import vol_2 from './sounds/03.mp3';
import vol_3 from './sounds/04.mp3';
...
class DrumPad {
  constructor() {
    ...
    this.vol_0.setAttribute('src', vol_0);
    this.vol_1 = document.querySelector('.vol-1');
    this.vol_1.setAttribute('src', vol_1);
    this.vol_2 = document.querySelector('.vol-2');
    this.vol_2.setAttribute('src', vol_2);
    this.vol_3 = document.querySelector('.vol-3');
    this.vol_3.setAttribute('src', vol_3);
